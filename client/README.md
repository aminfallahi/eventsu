# open-event-android
[![Build Status](https://travis-ci.com.aminfallahi/open-event-android.svg?branch=development)](https://travis-ci.com.aminfallahi/open-event-android?branch=development)
[![Build Status](https://travis-ci.com.aminfallahi/open-event-android.svg?branch=master)](https://travis-ci.com.aminfallahi/open-event-android?branch=master)
[![Join the chat at https://gitter.im/aminfallahi/open-event-android](https://badges.gitter.im/aminfallahi/open-event-android.svg)](https://gitter.im/aminfallahi/open-event-android?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge)
...
Our chat channel is on gitter [here](https://gitter.im/aminfallahi/open-event-android)
 ...
 * **apk** This branch contains two apk's, that are automatically generated on the merged pull request a) debug apk and b) release apk.
    - Please download and test the app that is using the code from the dev and master branches [here](https://github.com/aminfallahi/open-event-android/tree/apk).
### Code practices
